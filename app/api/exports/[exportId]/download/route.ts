...
export async function GET(
  ...
  try {
    ...
    const backendResponse = await fetch(
      `${BACKEND_URL}/exports/${exportId}/download`,
      {
        method: "GET",
        headers: {
          "x-user-id": userId,
    ...
    if (!backendResponse.ok) {
      ...
      return NextResponse.json(
        { error: errorData.error || errorData.message || "Failed to download export" },
    ...
    console.error("Error in export download API route:", error);
    return NextResponse.json(
